...
declare module "twobj" {
	...
	export interface CreateStyled {
		...
		<
			...
			ForwardedProps extends keyof React.JSX.IntrinsicElements[Tag] & string =
				keyof React.JSX.IntrinsicElements[Tag] & string,
		>(
			tag: Tag,
	...
	export function wrap(arr: TemplateStringsArray): (arg: CSSInterpolation) => {}
	export function tx(arr: TemplateStringsArray): {}
}

...
export declare type TokenString = NodeToken & NodeData
...
export declare type Variant = SimpleVariant | ArbitrarySelector | ArbitraryVariant
...
export declare type TwExpression = Classname | ArbitraryClassname | ArbitraryProperty | VariantSpan | Group
...
export declare type Node =
	...
	| WithOpacity
	| EndOpacity
export declare type BracketNode =
	| Group
	| ArbitrarySelector
	| ArbitraryVariant
	| ArbitraryClassname
